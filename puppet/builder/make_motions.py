...
def define():
    ...
    M["surprised"] = motion(D, [
        ...
        curve("ParamMouthForm", [(0, 0), (0.2, -0.4), (1.4, -0.4), (2.1, 0), (D, 0)]),
    ])
    ...
    D = 3.2
    M["talk"] = motion(D, [
        curve("ParamMouthOpenY", [(0, 0), (0.15, 0.7), (0.3, 0.2), (0.45, 0.8), (0.62, 0.15), (0.8, 0.6), (0.95, 0.1),
                                  (1.2, 0.1), (1.35, 0.75), (1.5, 0.25), (1.7, 0.85), (1.88, 0.2), (2.05, 0.6),
                                  (2.25, 0.1), (2.45, 0.5), (2.7, 0), (D, 0)]),
        curve("ParamMouthForm", [(0, 0), (0.3, 0.4), (1.2, 0.2), (2.0, 0.5), (2.7, 0.2), (D, 0)]),
        curve("ParamAngleX", [(0, 0), (0.6, 5), (1.3, -3), (2.1, 4), (2.8, 0), (D, 0)]),
        curve("ParamAngleY", [(0, 0), (0.4, 3), (1.1, -2), (1.8, 3), (2.6, 0), (D, 0)]),
        curve("ParamBodyAngleX", [(0, 0), (0.8, 2), (1.8, -1), (2.8, 0), (D, 0)]),
    ])
